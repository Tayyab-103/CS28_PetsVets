...
import RegisterBoarding from './screens/RegisterBoarding'
    ...
    <Router>
      ...
      <main className="py-3">
        <Container>
          ...
          <Route path="/signup/doctor" component={RegisterDoctor} />
          <Route path="/signup/boarding" component={RegisterBoarding} />
          ...
          <Route path="/admin/appointmentlist" component={AppointmentList} />
