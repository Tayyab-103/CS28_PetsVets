...
const RentingDetails = ({ history, match }) => {
  ...
  const {
    success: successRentingReview,
    loading: loadingRentingReview,
    error: errorRentingReview,
  } = rentingReviewCreate
      ...
      for (let order of myOrders)
        if (order["isDelivered"])
          for (let item of order["orderItems"])
            if (item["product"] === renting["_id"]) flag = true
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    dispatch(
      createRentingReview(match.params.id, {
        rating,
        comment,
      })
    )
          ...
          <Row>
            ...
            <Col md={3}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  Price: Rs.{renting.price}/PER_HOUR
                </ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <Row>
                      <Col>Price:</Col>
                      <Col>
                        <strong>Rs.{renting.price}/PER_HOUR</strong>
                      </Col>
                    </Row>
                  </ListGroup.Item>
                  ...
                  <ListGroup.Item>
                    <Row>
                      <Col>Status:</Col>
                      <Col>
                        {renting.countInStock > 0 ? "In Stock" : "Out Of Stock"}
                      </Col>
                    </Row>
                  </ListGroup.Item>
                    ...
                    <ListGroup.Item>
                      <Row>
                        ...
                        <Col>
                          ...
                          >
                            {[...Array(renting.countInStock).keys()].map(
                              (x) => (
            ...
            <Col md={6}>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  ...
                  {errorRentingReview && (
                    <Message variant="danger">{errorRentingReview}</Message>
                  )}
                  {userInfo ? (
