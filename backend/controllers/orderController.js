...
const delOrders = asyncHandler(async (req, res) => {
...
const postAppointment = asyncHandler(async (req, res) => {
  ...
  const { name, email, address, postalCode, phone, city, date } = req.body

  const user = await Appointment.create({ name, email, address, city, postalCode, phone, date })
